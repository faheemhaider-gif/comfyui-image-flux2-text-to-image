...
Submission: https://comfy.getrunpod.io/dashboard/submissions/kd7eeke2frj662rhkw927pjfex87wgja
## Pull the prebuilt image

We've already built and published this image on Docker Hub:

```bash
docker pull timpietruskyrunpod/comfyui-wizard:kd7eeke2frj662rhkw927pjfex87wgja
docker run --rm --gpus all -p 8188:8188 timpietruskyrunpod/comfyui-wizard:kd7eeke2frj662rhkw927pjfex87wgja
```
